...
const (
	StatsService_GetStats_FullMethodName = "/photos_ng.api.v1.grpc.StatsService/GetStats"
)
...
type StatsServiceClient interface {
	// Get application statistics including album count, media count, and years with media
...
var StatsService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "photos_ng.api.v1.grpc.StatsService",
