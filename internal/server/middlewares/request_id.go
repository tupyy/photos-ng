...
// RequestID generates a unique request ID for each HTTP request and injects it
// into both the gin.Context and the request's context.Context for consistent
