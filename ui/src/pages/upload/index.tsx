  ...
  return (
    <div className="max-w-4xl mx-auto py-6 sm:px-6 lg:px-8">
      ...
      <div className="px-4 py-6 sm:px-0">
        ...
        {/* Drop Zone */}
        <div
          className={`rounded-2xl border-2 border-dashed border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 p-8 transition-all flex flex-col items-center justify-center text-center ${
              ...
              <div className="flex items-center gap-1 sm:gap-2">
                {!isUploading && (
                  <button
                    ...
                    className="px-3 py-1.5 text-xs sm:text-sm text-gray-600 hover:text-red-600 dark:text-gray-400 dark:hover:text-red-400 transition-colors"
                  >
                    Clear
                  </button>
                )}
                <button
                  ...
                  className="px-3 py-1.5 text-xs sm:text-sm border border-gray-300 dark:border-gray-600 rounded-md text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-800 disabled:opacity-50 disabled:cursor-not-allowed transition-colors whitespace-nowrap"
                >
                  Cancel
                </button>
                <button
                  ...
                  className="px-3 py-1.5 text-xs sm:text-sm bg-blue-600 hover:bg-blue-700 text-white rounded-md disabled:opacity-50 disabled:cursor-not-allowed transition-colors whitespace-nowrap"
                >
