...
ARG AUTHZ_ENABLED=false
ARG REACT_APP_KEYCLOAK_LOGOUT_URL
ARG REACT_APP_ENVOY_SIGNOUT_URL
ARG REACT_APP_OIDC_CLIENT_ID

ENV GIT_SHA=${GIT_SHA}
ENV AUTH_ENABLED=${AUTH_ENABLED}
ENV AUTHZ_ENABLED=${AUTHZ_ENABLED}
ENV REACT_APP_KEYCLOAK_LOGOUT_URL=${REACT_APP_KEYCLOAK_LOGOUT_URL}
ENV REACT_APP_ENVOY_SIGNOUT_URL=${REACT_APP_ENVOY_SIGNOUT_URL}
